...
import signupSchema, { SignupFormInputs } from "./signupSchema";
...
const SignupForm: React.FC<SignupFormProps> = ({ submitForm, loading }) => {
  ...
  const onSubmit = async (data: SignupFormInputs) => {
    ...
    if (result.success) {
      ...
      else setError("password", { type: "server", message: result.error });
    }
  };
